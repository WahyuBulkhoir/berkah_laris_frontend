...
const menuItems = [
  ...
  { path: '/admin/add-product', label: 'Tambah Produk', icon: 'fas fa-plus-square' },
  { path: '/admin/add-category', label: 'Tambah Kategori', icon: 'fas fa-tags' },
  { path: '/admin/product-list', label: 'Daftar Produk', icon: 'fas fa-boxes' },
  { path: '/admin/order-list', label: 'Daftar Pemesanan', icon: 'fas fa-shopping-cart' },
  { path: '/admin/sales-report', label: 'Laporan Penjualan', icon: 'fas fa-chart-line' },
]
</script>
