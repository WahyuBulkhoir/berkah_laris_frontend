    ...
    <footer class="bg-gray-800 text-white">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-4">
                        <li v-for="link in productLinks" :key="link">
                            <a href="#" class="text-base text-gray-400 hover:text-white">{{ link }}</a>
                        </li>
                    </ul>
                </div>
                <div>
                    <h3 class="text-sm font-semibold text-gray-300 tracking-wider uppercase">Layanan</h3>
                    <ul class="mt-4 space-y-4">
            ...
            <div class="mt-12 border-t border-gray-700 pt-8">
                <p class="text-base text-gray-400 text-center">&copy; {{ new Date().getFullYear() }} BerkahLaris. Hak
                    Cipta Dilindungi.</p>
            </div>
        </div>
    </footer>
